...
function serializeMetadata(page) {
  const metadata = {
    ...
    preferred_name: page.preferredName ?? '',
    cornie_relationship: page.cornieRelationship ?? '',
    identity_summary: page.identitySummary ?? '',
    life_stage_summary: page.lifeStageSummary ?? '',
    current_focus: page.currentFocus ?? '',
    stressors: page.stressors ?? '',
    communication_preference: page.communicationPreference ?? '',
    person_name: page.personName ?? '',
    relationship_to_user: page.relationshipToUser ?? '',
    role_summary: page.roleSummary ?? '',
    personality_summary: page.personalitySummary ?? '',
    meaning_to_user: page.meaningToUser ?? '',
    shared_experience_summary: page.sharedExperienceSummary ?? '',
    emotional_weight: page.emotionalWeight ?? '',
    timeline_summary: page.timelineSummary ?? '',
    first_known_period: page.firstKnownPeriod ?? '',
    preference_type: page.preferenceType ?? '',
    stance: page.stance ?? '',
    stability_level: page.stabilityLevel ?? '',
    trait_type: page.traitType ?? '',
    confidence_level: page.confidenceLevel ?? '',
    trait_summary: page.traitSummary ?? '',
...
function toPageInput(parsed, filePath) {
  return {
    ...
    user_name: parsed.metadata.user_name,
    preferred_name: parsed.metadata.preferred_name,
    cornie_relationship: parsed.metadata.cornie_relationship,
    identity_summary: parsed.metadata.identity_summary,
    life_stage_summary: parsed.metadata.life_stage_summary,
    current_focus: parsed.metadata.current_focus,
    stressors: parsed.metadata.stressors,
    communication_preference: parsed.metadata.communication_preference,
    person_name: parsed.metadata.person_name,
    relationship_to_user: parsed.metadata.relationship_to_user,
    role_summary: parsed.metadata.role_summary,
    personality_summary: parsed.metadata.personality_summary,
    meaning_to_user: parsed.metadata.meaning_to_user,
    shared_experience_summary: parsed.metadata.shared_experience_summary,
    emotional_weight: parsed.metadata.emotional_weight,
    timeline_summary: parsed.metadata.timeline_summary,
    first_known_period: parsed.metadata.first_known_period,
    ...
    trait_type: parsed.metadata.trait_type,
    confidence_level: parsed.metadata.confidence_level,
    trait_summary: parsed.metadata.trait_summary,
